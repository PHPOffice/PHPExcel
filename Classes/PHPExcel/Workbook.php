...
class Workbook
{
     ...
     * Set properties
     *
     * @param PHPExcel\DocumentProperties    $pValue
     */
     ...
     * Set security
     *
     * @param PHPExcel\DocumentSecurity    $pValue
     */
     ...
     * Add external sheet
     *
     * @param  PHPExcel\Worksheet $pSheet External sheet to add
     * @param  int|null $iSheetIndex Index where sheet should go (0,1,..., or null for last)
     * @throws PHPExcel\Exception
     * @return PHPExcel\Worksheet
     */
     ...
     * Add named range
     *
     * @param  PHPExcel\NamedRange $namedRange
     * @return Workbook
     */
     ...
     * @return PHPExcel\NamedRange|null
     */
     ...
     *
     * @return PHPExcel\WorksheetIterator
     */
     ...
     *
     * @param  PHPExcel\Style $pCellStyle
     * @return boolean
     */
