...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
	...
	$this->setCodeName($this->getTitle());//setTitle can change $pTitle
   ...
   /**
	...
	private static function _checkSheetCodeName($pValue)
	{
		...
		if ((str_replace(self::$_invalidCharacters, '', $pValue) !== $pValue) or (PHPExcel_Shared_String::Substring($pValue,-1,1)=='\'') or (PHPExcel_Shared_String::Substring($pValue,0,1)=='\'')) {
...
/**
	...
	*/
	public function setCodeName($pValue=null){
		...
		// Syntax check
		self::_checkSheetCodeName($pValue);//throw an exception if not valid
