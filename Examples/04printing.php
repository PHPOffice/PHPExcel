...
$objDrawing = new \PhpOffice\PhpExcel\Worksheet\HeaderFooterDrawing();
$objDrawing->setName('PHPExcel logo');
$objDrawing->setPath('./images/phpexcel_logo.gif');
$objDrawing->setHeight(36);
$objPHPExcel->getActiveSheet()->getHeaderFooter()->addImage($objDrawing, \PhpOffice\PhpExcel\Worksheet\HeaderFooter::IMAGE_HEADER_LEFT);
