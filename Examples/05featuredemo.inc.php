...
$objPHPExcel->getActiveSheet()->setCellValue('D1', \PhpOffice\PhpExcel\Shared\Date::PHPToExcel( gmmktime(0,0,0,date('m'),date('d'),date('Y')) ));
$objPHPExcel->getActiveSheet()->getStyle('D1')->getNumberFormat()->setFormatCode(\PhpOffice\PhpExcel\Style\NumberFormat::FORMAT_DATE_XLSX15);
...
$objPHPExcel->getActiveSheet()->getStyle('E4:E13')->getNumberFormat()->setFormatCode(\PhpOffice\PhpExcel\Style\NumberFormat::FORMAT_CURRENCY_EUR_SIMPLE);
...
$objPHPExcel->getActiveSheet()->getStyle('B1')->getFont()->setUnderline(\PhpOffice\PhpExcel\Style\Font::UNDERLINE_SINGLE);
$objPHPExcel->getActiveSheet()->getStyle('B1')->getFont()->getColor()->setARGB(\PhpOffice\PhpExcel\Style\Color::COLOR_WHITE);

$objPHPExcel->getActiveSheet()->getStyle('D1')->getFont()->getColor()->setARGB(\PhpOffice\PhpExcel\Style\Color::COLOR_WHITE);
$objPHPExcel->getActiveSheet()->getStyle('E1')->getFont()->getColor()->setARGB(\PhpOffice\PhpExcel\Style\Color::COLOR_WHITE);
...
$objPHPExcel->getActiveSheet()->getStyle('D11')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT);
$objPHPExcel->getActiveSheet()->getStyle('D12')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT);
$objPHPExcel->getActiveSheet()->getStyle('D13')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT);

$objPHPExcel->getActiveSheet()->getStyle('A18')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_JUSTIFY);
$objPHPExcel->getActiveSheet()->getStyle('A18')->getAlignment()->setVertical(\PhpOffice\PhpExcel\Style\Alignment::VERTICAL_CENTER);
...
$styleThickBrownBorderOutline = array(
	'borders' => array(
		'outline' => array(
			'style' => \PhpOffice\PhpExcel\Style\Border::BORDER_THICK,
...
$objPHPExcel->getActiveSheet()->getStyle('A1:E1')->getFill()->setFillType(\PhpOffice\PhpExcel\Style\Fill::FILL_SOLID);
...
$objPHPExcel->getActiveSheet()->getStyle('A3:E3')->applyFromArray(
		array(
			...
			'alignment' => array(
				'horizontal' => \PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT,
			),
			'borders' => array(
				'top'     => array(
 					'style' => \PhpOffice\PhpExcel\Style\Border::BORDER_THIN
...
$objPHPExcel->getActiveSheet()->getStyle('A3')->applyFromArray(
		array(
			'alignment' => array(
				'horizontal' => \PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_LEFT,
			),
			'borders' => array(
				'left'     => array(
 					'style' => \PhpOffice\PhpExcel\Style\Border::BORDER_THIN
...
$objPHPExcel->getActiveSheet()->getStyle('B1')->getProtection()->setLocked(\PhpOffice\PhpExcel\Style\Protection::PROTECTION_UNPROTECTED);
...
$objPHPExcel->getActiveSheet()->getStyle('E26')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT);
...
$objPHPExcel->getActiveSheet()->getStyle('E27')->getAlignment()->setHorizontal(\PhpOffice\PhpExcel\Style\Alignment::HORIZONTAL_RIGHT);
...
$objPHPExcel->getActiveSheet()->getPageSetup()->setOrientation(\PhpOffice\PhpExcel\Worksheet\PageSetup::ORIENTATION_PORTRAIT);
$objPHPExcel->getActiveSheet()->getPageSetup()->setPaperSize(\PhpOffice\PhpExcel\Worksheet\PageSetup::PAPERSIZE_A4);
...
$objPHPExcel->getActiveSheet()->getStyle('A1')->getFont()->setUnderline(\PhpOffice\PhpExcel\Style\Font::UNDERLINE_SINGLE);
