...
$objPHPExcel1 = \PhpOffice\PhpExcel\IOFactory::load(dirname(__FILE__) . "/templates/43mergeBook1.xlsx");
...
$objPHPExcel2 = \PhpOffice\PhpExcel\IOFactory::load(dirname(__FILE__) . "/templates/43mergeBook2.xlsx");
...
$objWriter = \PhpOffice\PhpExcel\IOFactory::createWriter($objPHPExcel1, 'Excel2007');
