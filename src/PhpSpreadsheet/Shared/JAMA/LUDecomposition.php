...
class LUDecomposition
{
    ...
    public function __construct($A)
    {
        if ($A instanceof Matrix) {
            ...
            throw new \PhpOffice\PhpExcel\Calculation\Exception(Matrix::ARGUMENT_TYPE_EXCEPTION);
        }
    ...
    public function solve($B)
    {
        if ($B->getRowDimension() == $this->m) {
            ...
            throw new \PhpOffice\PhpExcel\Calculation\Exception(self::MATRIX_SQUARE_EXCEPTION);
        }
    }
}
