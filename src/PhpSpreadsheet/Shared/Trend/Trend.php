...
/**
 * PhpOffice\PhpExcel\Shared\Trend\Trend
 *
...
class Trend
{
     ...
     *
     * @var \PhpOffice\PhpExcel\Trend\Shared\BestFit[]
     **/
        ...
        switch ($trendType) {
            ...
            case self::TREND_POWER:
                if (!isset(self::$trendCache[$key])) {
                    $className = '\\PhpOffice\\PhpExcel\\'.$trendType.'BestFit';
            ...
            case self::TREND_BEST_FIT_NO_POLY:
                ...
                foreach (self::$trendTypes as $trendMethod) {
                    $className = '\\PhpOffice\\PhpExcel\\'.$trendMethod.'BestFit';
