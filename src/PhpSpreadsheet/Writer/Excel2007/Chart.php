    ...
    private static function getChartType($plotArea)
    {
        ...
        if ($groupCount == 1) {
            ...
            if (count($chartTypes) == 0) {
                throw new \PhpOffice\PhpExcel\Writer\Exception('Chart is not yet implemented');
            }
        }
