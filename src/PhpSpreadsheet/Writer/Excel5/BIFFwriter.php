...
/**
 * PhpOffice\PhpExcel\Writer\Excel5\BIFFwriter
 *
    ...
    public static function getByteOrder()
    {
        if (!isset(self::$byteOrder)) {
            ...
            if ($number == $teststr) {
                ...
                throw new \PhpOffice\PhpExcel\Writer\Exception("Required floating point format not supported on this platform.");
            }
