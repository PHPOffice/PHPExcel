...
if (extension_loaded('xdebug')) {
    ...
    printf(
        "Xdebug not found, you should run the following at the command line: echo 'zend_extension=%s/xdebug.so' | sudo tee -a `php -i | grep 'Loaded Configuration File' | awk '{print \$5}'`\n",
